...
public class ViewCart extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		LibraryUtility.doHeader(out, "Cart"); // print html header elements
	...
	private void continueSession(HttpServletRequest request, HttpServletResponse response, PrintWriter out,
		...
		displayCart(response, out, session, name, borrowerNo);
		LibraryUtility.doFooter(out);
	} // continueSession

	private void displayCart(HttpServletResponse response, PrintWriter out, HttpSession session, String name,
			String borrowerNo) {
		// display the cart
